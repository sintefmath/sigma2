...
do
  ...
  cmake -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} \
    ...
    -DCMAKE_EXE_LINKER_FLAGS="-fsanitize=${CLANG_SANITIZER} -stdlib=libc++ -lc++abi -L${INSTALL_PREFIX}/lib" \
    -DCMAKE_SHARED_LINKER_FLAGS="-fsanitize=${CLANG_SANITIZER} -stdlib=libc++ -lc++abi -L${INSTALL_PREFIX}/lib" \
